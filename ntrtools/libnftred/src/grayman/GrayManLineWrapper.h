#ifndef GRAYMANLINEWRAPPER_H
#define GRAYMANLINEWRAPPER_H
...
class GrayManLineWrapper : public BlackT::TLineWrapper {
public:
  typedef std::map<int, int> CharSizeTable;

  GrayManLineWrapper(BlackT::TStream& src__,
//                  BlackT::TStream& dst__,
  ...
  /**
   * Returns the string used for linebreak symbol.
   */
